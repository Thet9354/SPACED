...
public class High_quality_videos_Activity extends AppCompatActivity {
    ...
    private String highQualityVideo = "On Cellular of Wifi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_quality_videos);
    ...
    private void pageDirectories() {
        ...
        rb_never.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b)
                    highQualityVideo = "Never";
            }
        });

        rb_onlyWifi.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b)
                    highQualityVideo = "Only Wifi";
            }
        });

        rb_onCellular.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b)
                    highQualityVideo = "On Cellular of Wifi";
            }
        });
    }
        ...
        btn_verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    user.put("High Quality Videos", highQualityVideo);
                    ...
                    databaseReference.child(mPhoneNumber)
                            ...
                            .updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    {
                                        Toast.makeText(High_quality_videos_Activity.this, "Yessir we did it", Toast.LENGTH_SHORT).show();

                                        //TODO: Update data in firestore here
                                    }
                                    else
                                        Toast.makeText(High_quality_videos_Activity.this, "An error occurred during update, please try again later", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
