...
public class adPreference_Activity extends AppCompatActivity {
    ...
    private String personalizedAds = "ON";
                            ...
                            .updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if (task.isSuccessful())
                                    {
                                                            ...
                                                            firestoreDB.collection("user")
                                                                    ...
                                                                    .update(user).addOnSuccessListener(new OnSuccessListener() {
                                                                        ...
                                                                        public void onSuccess(Object o) {
                                                                            Toast.makeText(adPreference_Activity.this, "Successfully updated", Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    }).addOnFailureListener(new OnFailureListener() {
                                                                        @Override
                                                                        public void onFailure(@NonNull Exception e) {
                                                                            Toast.makeText(adPreference_Activity.this, "An error occurred, please try again later", Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    });
                                                        }
                                                    }
                                        ...
                                        Toast.makeText(adPreference_Activity.this, "An error occured during update, please try again later", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
